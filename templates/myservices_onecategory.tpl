...
<div class="buy">
    ...
    <a href="<{$category.categories_url}>" title="<{$smarty.const._MYSERVICES_SEE_PRODUCTS}>"><img src="<{$smarty.const.MYSERVICES_IMAGES_URL}>services.jpg" alt="<{$smarty.const._MYSERVICES_SEE_PRODUCTS}>" border="0"></a><br>
