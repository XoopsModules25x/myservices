 ...
 * Version : $Id: checkout.php 26 2007-12-20 13:25:03Z hthouzard $
 * ****************************************************************************
 */
 ...
 */
require 'header.php';
$xoopsOption['template_main'] = 'myservices_order.html';
...
switch ($op)
{
	...
	// ****************************************************************************************************************
		...
		if( !isset($_POST['cgv']) || (isset($_POST['cgv']) && intval($_POST['cgv'])!= 1) ) {
