...
class ActiveCalendar
{
    ...
    */
    ...
    public function __construct($year = false, $month = false, $day = false, $GMTDiff = 'none')
    {
        ...
        if (1 == $this->isSchalt && 2 == $this->actmonth) {
            $this->maxdays = 29;
        } elseif (1 != $this->isSchalt && 2 == $this->actmonth) {
            $this->maxdays = 28;
        } elseif (1 == $this->has31days) {
            $this->maxdays = 31;
        } else {
            $this->maxdays = 30;
        }
    ...
    */
    ...
    public function mkDay($var)
    {
        ...
        if ($this->isEvent($var)) {
            if ($this->eventUrl) {
                // Modification Hervé
                if (0 === mb_stripos($this->eventUrl, 'javascript:')) {
    ...
    */
    ...
    {
        if (false === mb_strpos($this->url, '?')) {
            $glue = '?';
        } else {
            $glue = '&amp;';
        }
        if (false === mb_strpos($this->urlNav, '?')) {
            $glueNav = '?';
        } else {
            $glueNav = '&amp;';
        }
    ...
    */
    ...
    public function mkWeekNum($var)
    {
        ...
        if ($week > 50 && 1 == $this->actmonth) {
            $year = $this->actyear - 1;
        }
        $out = '';
        if ($this->weekUrl) {
            if (false === mb_strpos($this->weekUrl, '?')) {
                $glue = '?';
            } else {
                $glue = '&amp;';
            }
    ...
    */
    ...
    public function getMonthDays($month, $year)
    {
        ...
        if (1 == $isSchalt && 2 == $month) {
            $maxdays = 29;
        } elseif (1 != $isSchalt && 2 == $month) {
            $maxdays = 28;
        } elseif (1 == $has31days) {
            $maxdays = 31;
        } else {
