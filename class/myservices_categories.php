...
class myservices_categories extends myservices_Object
{
    ...
    public function getCategoryLink()
    {
        ...
        if (myservices_utils::getModuleOption('urlrewriting') == 1) {    // On utilise l'url rewriting
            $url = MYSERVICES_URL . 'category-' . (int)$cat_cid . myservices_utils::makeSeoUrl($cat_title) . '.html';
...
class MyservicesMyservices_categoriesHandler extends myservices_ORM
{
     ...
     *
     * @param myservices_categories|object Objet de type catégorie qui représente la catégorie courante
     ...
     */
    public function getBreadCrumb(myservices_categories $currentCategory, $raquo = ' &raquo; ')
    {
        require_once XOOPS_ROOT_PATH . '/class/tree.php';
