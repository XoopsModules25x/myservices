...
class MyservicesMyservices_prefsHandler extends myservices_ORM
{
	 ...
	 */
	function canOrderNow($year, $month, $day, $hour)
	{
	 ...
	 */
	function getFirstAvailableDayForOrder()
	{
		global $hMsCalendar;
		$now = time();
		$latence = myservices_utils::getModuleOption('latence') * 3600;
	 ...
	 * @return boolean Vrai = magasin ouvert, False = magasin fermé
	 */
	function isStoreOpen($year, $month, $day, $hour, $strict = false)
	{
