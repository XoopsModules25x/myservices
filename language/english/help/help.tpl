<div id="help-template" class="outer">
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check it out the status of the tutorial <a href="https://xoops.gitbook.io/myservices-tutorial/" target="_blank">here </a>.
